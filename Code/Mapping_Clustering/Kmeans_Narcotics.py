...
df = pd.read_csv('narloc_crime_updates.csv')
print(df)
...
plt.title('K-Means Clustering of Narcotics Crimes')
plt.show()
plt.savefig('KMeans_Narcotics_Map')
