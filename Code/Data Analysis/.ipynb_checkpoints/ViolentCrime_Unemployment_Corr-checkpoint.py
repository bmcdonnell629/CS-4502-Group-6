...
#print correlation of Violent crime and unemployment rate
print(corr_df.corr())

#plot Violent Crime vs Unemployment rate
x = corr_df['crime']
y = corr_df['unemployment']

plt.scatter(x, y)
plt.xlabel("Monthly ViolentCrime Rate per 1000 people")
plt.ylabel("Monthly Unemployment Rate")
plt.title('Monthly Violent Crime Rate vs Monthly Unemployment Rate')

m, b = np.polyfit(x, y, 1)
plt.plot(x, m*x+b, color='red')

plt.savefig('Monthly Violent Crime Rate vs Monthly Unemployment Rate')
plt.clf()